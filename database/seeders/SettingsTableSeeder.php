...
class SettingsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $data = [
            ...
            ['type' => 'term_ends', 'description' => '8/10/2024'],
            ['type' => 'term_begins', 'description' => '7/10/2023'],
            ['type' => 'phone', 'description' => '0123456789'],
            ['type' => 'address', 'description' => 'Jl. Adi Sucipto No.38, Kerten, Kec. Laweyan, Kota Surakarta, Jawa Tengah 57143'],
            ['type' => 'system_email', 'description' => 'viskament@gmail.com'],
            ['type' => 'alt_email', 'description' => 'smkn6@gmail.com'],
