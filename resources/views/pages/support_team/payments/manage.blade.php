...
@section('page_title', 'Pembayaran Murid')
@section('content')
    <div class="card">
        <div class="card-header header-elements-inline">
            <h5 class="card-title"><i class="icon-cash2 mr-2"></i> Pembayaran Murid</h5>
            {!! Qs::getPanelOptions() !!}
        </div>
                ...
                <table class="table datatable-button-html5-columns">
                    ...
                    @foreach($students as $s)
                        <tr>
                            ...
                            <td>
                                <div class="dropdown">
                                    <a href="#" class=" btn btn-danger" data-toggle="dropdown"> Manage Pembayaran <i class="icon-arrow-down5"></i>
                                    </a>
