...
@section('page_title', 'Informasi Murid - '.$my_class->name)
@section('content')

    <div class="card">
        <div class="card-header header-elements-inline">
            <h6 class="card-title">Daftar Murid</h6>
            {!! Qs::getPanelOptions() !!}
        </div>

        <div class="card-body">
            <ul class="nav nav-tabs nav-tabs-highlight">
                <li class="nav-item"><a href="#all-students" class="nav-link active" data-toggle="tab">Semua {{ $my_class->name }} Murid</a></li>
                <li class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Tingkat Kelas</a>
                                    ...
                                    <td class="text-center">
                                        <div class="list-icons">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a href="{{ route('students.show', Qs::hash($sr->id)) }}" class="dropdown-item"><i class="icon-eye"></i> Lihat Info</a>
                                                    @if(Qs::userIsTeamSA())
                                                    ...
                                                    @endif
                                                    <a href="#" class="dropdown-item"><i class="icon-check"></i> Lembar Penilaian</a>
