                        ...
                        <div class="card">
                            <div class="card-header header-elements-inline">
                                <h6 class="card-title font-weight-bold">
                                    {{ $tt->exam_date ? 'Exam (' . date('D\, d/m/Y', strtotime($tt->exam_date)) . ')' : $tt->day }}
                                    {{ '(' . $tt->time_slot->full . ')' . ' - ' . $tt->subject->name }}</h6>
                                <div class="header-elements">
                                    <div class="list-icons">
                                        <a onclick="confirmDelete(this.id)" href="#" id="{{ $tt->id }}"
                                            title="DELETE" class="list-icons-item text-danger"><i
                                ...
                                <div class="col-md-12">
                                    <form method="post" action="{{ route('tt.update', $tt->id) }}">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <select id="day" name="day" required type="text"
                                                        class="form-control select" data-placeholder="Select Day...">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <label for="ts_id"
                                                class="col-lg-3 col-form-label font-weight-semibold">Time Slot <span
