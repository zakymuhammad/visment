                            ...
                            <form method="post" action="{{ route('my_account.change_pass') }}">
                                ...
                                <div class="form-group row">
                                    <label for="current_password"
                                        class="col-lg-3 col-form-label font-weight-semibold">Current Password <span
                                ...
                                <div class="form-group row">
                                    <label for="password" class="col-lg-3 col-form-label font-weight-semibold">New Password
                            ...
                            <div class="col-md-6">
                                <form enctype="multipart/form-data" method="post"
                                    ...
                                    @if ($my->username)
                                        <div class="form-group row">
                                            <label for="username"
                                                class="col-lg-3 col-form-label font-weight-semibold">Username</label>
                                            <div class="col-lg-9">
                                    ...
                                    <div class="form-group row">
                                        <label for="phone2"
                                            class="col-lg-3 col-form-label font-weight-semibold">Telephone </label>
                                        <div class="col-lg-9">
