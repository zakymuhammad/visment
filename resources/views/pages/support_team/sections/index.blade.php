...
@section('page_title', 'Manage Tingkat Kelas')
@section('content')

    <div class="card">
        <div class="card-header header-elements-inline">
            <h6 class="card-title">Manage Tingkat Kelas</h6>
            {!! Qs::getPanelOptions() !!}
        </div>

        <div class="card-body">
            <ul class="nav nav-tabs nav-tabs-highlight">
                <li class="nav-item"><a href="#new-section" class="nav-link active" data-toggle="tab">Tambah Tingkat Kelas</a>
                </li>
                <li class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Manage Tingkat Kelas</a>
                            ...
                            <form class="ajax-store" method="post" action="{{ route('sections.store') }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input name="name" value="{{ old('name') }}" required type="text"
                                            class="form-control" placeholder="Nama Tingkat">
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label for="my_class_id" class="col-lg-3 col-form-label font-weight-semibold">Pilih Kelas <span class="text-danger">*</span></label>
                                    <div class="col-lg-9">
                                ...
                                <div class="form-group row">
                                    <label for="teacher_id"
                                        class="col-lg-3 col-form-label font-weight-semibold">Guru</label>
                                    <div class="col-lg-9">
                                        <select data-placeholder="Pilih Guru" class="form-control select-search"
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-left">
                                                        ...
                                                        @if (Qs::userIsSuperAdmin())
                                                            ...
                                                            <form method="post" id="item-delete-{{ $s->id }}"
                                                                action="{{ route('sections.destroy', $s->id) }}"
